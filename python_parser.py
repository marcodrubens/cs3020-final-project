    ...
    def trans_expr(e):
        match e:
            ...
            case ast.BinOp(e1, ast.Add(), e2):
                e1_const = isinstance(e1, ast.Constant) and isinstance(e1.value, str)
                e2_const = isinstance(e2, ast.Constant) and isinstance(e2.value, str)
                op = 'concat' if e1_const and e2_const else 'add'
                return Prim(op, [trans_expr(e1), trans_expr(e2)])
